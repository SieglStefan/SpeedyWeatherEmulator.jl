...
using .DataStructs: TrainingData, MyModel, Losses, gpu_usage
...
# Saving model
function save_model(model::MyModel, td::TrainingData)
...
model = MyModel(input_dim=54, hidden_dim=128, output_dim=54)
