...
#sim_para = SimPara(trunc=5, n_steps=8, n_ic = 1, storage_key="_test12")
#create_sim_data(sim_para, overwrite=true)
#sim_data = SimData(sim_para)
#ave_sim_data(sim_data)
#sim_data_new = load_sim_data(sim_para)
...
#vor0 = sim_data.data[:, 5, 1]
#vorSW = sim_data.data[:, 6, 1]
#vorEM = tm(vor0)
